...
class S_SPAWN final :
 ...
 public:
  ...
  // repeated .Protocol.ObjectInfo player = 1;
  int player_size() const;
  private:
  int _internal_player_size() const;
  public:
  void clear_player();
  ::Protocol::ObjectInfo* mutable_player(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ObjectInfo >*
      mutable_player();
  private:
  const ::Protocol::ObjectInfo& _internal_player(int index) const;
  ::Protocol::ObjectInfo* _internal_add_player();
  public:
  const ::Protocol::ObjectInfo& player(int index) const;
  ::Protocol::ObjectInfo* add_player();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ObjectInfo >&
      player() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ObjectInfo > player_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_Protocol_2eproto;
};
// -------------------------------------------------------------------
...
inline ::Protocol::ObjectInfo* S_SPAWN::mutable_player(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.S_SPAWN.player)
  return player_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ObjectInfo >*
S_SPAWN::mutable_player() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.S_SPAWN.player)
  return &player_;
}
inline const ::Protocol::ObjectInfo& S_SPAWN::_internal_player(int index) const {
  return player_.Get(index);
}
inline const ::Protocol::ObjectInfo& S_SPAWN::player(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.S_SPAWN.player)
  return _internal_player(index);
}
inline ::Protocol::ObjectInfo* S_SPAWN::_internal_add_player() {
  return player_.Add();
}
inline ::Protocol::ObjectInfo* S_SPAWN::add_player() {
  // @@protoc_insertion_point(field_add:Protocol.S_SPAWN.player)
  return _internal_add_player();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ObjectInfo >&
S_SPAWN::player() const {
  // @@protoc_insertion_point(field_list:Protocol.S_SPAWN.player)
  return player_;
}
